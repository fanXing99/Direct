...
@interface DirectNavBar : UINavigationBar
@end

@implementation DirectNavBar {
...
@interface DirectNavController : UINavigationController
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DirectNavController *nav = [[DirectNavController alloc] initWithNavigationBarClass:[DirectNavBar class] toolbarClass:[UIToolbar class]];
    ...
    [nav pushViewController:rootTabBarVC animated:NO];
